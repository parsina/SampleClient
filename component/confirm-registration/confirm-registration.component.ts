      ...
      .subscribe(data =>
        {
          ...
          if(result.success)
          {
            ...
            info = 'حساب کاربری شما فعال گردید. شما می توانید از این لحظه در مسابقات سایت شرکت نمایید. جهت کسب اطلاعات بیشتر در مورد چگونگی شرکت در مسابقات، واریز و برداشت و طرح پاداش، به بخش راهنمای سایت مراجعه نمایید.';
          }
          else
          {
